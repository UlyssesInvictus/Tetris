...
//*************************Files, Scanner, Exceptions Packages*****************
   import java.io.*;
   import java.util.Scanner;
/***********   Graphics Package:  Credit goes to javaranch.com.***********
							Used Only for the drawBevel method                */   
   import com.javaranch.common.AWT;
/**Initialize the Ultra Panel*/
    public class UltraPanel extends MarathonPanel
   {
       public UltraPanel(int[] x, TetrisTheme theme, int startLevel)
      {
         super(x, theme, startLevel);
      }
       public void gameOver()
      {
         if (matrix[tetrad.getHeight()][5].getFilled()==true||timePassed>=120)
         {
